...
const DeleteConfirm = ({ open, scheduleId, setOpen }: DeleteConfirmProps) => {
...
const DeleteRepeatConfirm = ({ open, scheduleId, setOpen }: DeleteConfirmProps) => {
  const router = useRouter();
...
export { DeleteConfirm, DeleteRepeatConfirm };
